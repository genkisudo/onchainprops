 ...
 * @property {string} [lowestFinalTarget]
...
const AppState = {
    ...
    /** @type {PropFirm[]} */
    propFirms: [
        { name: "Hypernova", country: "Cayman Islands", split: "80%", maxAccount: "$200,000", profitTarget: "10%", dailyDrawdown: "3-5%", maxDrawdown: "6-8%", website: "https://hn.xyz/r/rcvmoy", chain: "Hyperliquid", isAffiliate: true, token: "No", payoutSpeed: "~5s", rulesOnchain: "Yes", aiAgents: undefined, scaledCapital: undefined, evalDataOnchain: undefined, bestSplit: undefined, bestTargetToRisk: undefined, maxLeverage: undefined, bestLeverage: undefined, lowestFinalTarget: undefined, payoutsVerified: "Yes" },
        { name: "Propr", country: "BVI", split: "80%", maxAccount: "Up to $300k", profitTarget: "10%", dailyDrawdown: "3-5%", maxDrawdown: "6%", website: "https://app.propr.xyz/r/nCnJ5uZ9", chain: "Hyperliquid", isAffiliate: true, token: "Yes", payoutSpeed: "Soon", rulesOnchain: "No", aiAgents: "Yes", scaledCapital: undefined, evalDataOnchain: undefined, bestSplit: undefined, bestTargetToRisk: undefined, maxLeverage: undefined, bestLeverage: undefined, lowestFinalTarget: undefined, payoutsVerified: "Yes" },
        { name: "DojiFunded", country: "US (Delaware)", split: "Up to 90%", maxAccount: "$100,000", profitTarget: "10%", dailyDrawdown: "3-5%", maxDrawdown: "6-8%", website: "https://app.dojifunded.com/kol/onchainprops", chain: "Arbitrum", isAffiliate: true, token: "No", payoutSpeed: "TBC", rulesOnchain: "No", aiAgents: undefined, scaledCapital: undefined, evalDataOnchain: "Yes", bestSplit: undefined, bestTargetToRisk: undefined, maxLeverage: undefined, bestLeverage: undefined, lowestFinalTarget: undefined, payoutsVerified: "Yes" },
        { name: "hyperpnl", country: "Cayman Islands", split: "80%", maxAccount: "$25k ($200k soon)", profitTarget: "10%/5%", dailyDrawdown: "5%", maxDrawdown: "9%", website: "https://app.hyperpnl.com/?ref=0x10cf82402E3488dc6945832F6896162C15dc8146", chain: "Hyperliquid", isAffiliate: true, token: "No", payoutSpeed: "Soon", rulesOnchain: "No", aiAgents: undefined, scaledCapital: undefined, evalDataOnchain: undefined, bestSplit: undefined, bestTargetToRisk: undefined, maxLeverage: undefined, bestLeverage: undefined, lowestFinalTarget: undefined, payoutsVerified: "Yes" },
        { name: "Carrot Funding", country: "UAE", split: "80%", maxAccount: "$50k ($100k soon)", profitTarget: "5%/8%", dailyDrawdown: "4-5%", maxDrawdown: "8-10%", website: "https://app.carrotfunding.io/join/2VSSOTXBQZ", chain: "gTrade, Hyperliquid (soon)", isAffiliate: true, token: "Yes", payoutSpeed: "Within 24h", rulesOnchain: "No", aiAgents: undefined, scaledCapital: undefined, evalDataOnchain: undefined, bestSplit: undefined, bestTargetToRisk: undefined, maxLeverage: "200x", bestLeverage: "Yes", lowestFinalTarget: undefined, payoutsVerified: "Yes" },
        ...
        { name: "HyperStack", country: "BVI", split: "Up to 90%", maxAccount: "$400,000", profitTarget: "10%", dailyDrawdown: "5%", maxDrawdown: "5%", website: "https://www.hyperstack.trade/rules", chain: "Hyperliquid", isAffiliate: false, token: "No", payoutSpeed: "TBC", rulesOnchain: "TBC", aiAgents: undefined, scaledCapital: undefined, evalDataOnchain: undefined, bestSplit: undefined, bestTargetToRisk: undefined, maxLeverage: undefined, bestLeverage: undefined, lowestFinalTarget: undefined, payoutsVerified: "No" },
        { name: "FUNDED by FOXIFY", country: "BVI", split: "Up to 90%", maxAccount: "$10,000", profitTarget: "15%", dailyDrawdown: "N/A", maxDrawdown: "10-20%", website: "https://www.foxify.trade/", chain: "Hyperliquid (soon)", isAffiliate: false, token: "Yes", payoutSpeed: "Soon", rulesOnchain: "No", aiAgents: undefined, scaledCapital: undefined, evalDataOnchain: undefined, bestSplit: undefined, bestTargetToRisk: undefined, maxLeverage: undefined, bestLeverage: undefined, lowestFinalTarget: undefined, payoutsVerified: "No" }
    ],
    /** @type {PropFirm[]} */
    predictionMarketFirms: [
        { name: "Funding Predicts", country: "USA", split: "Up to 90%", maxAccount: "$150,000", profitTarget: undefined, dailyDrawdown: undefined, maxDrawdown: undefined, website: "https://fundingpredicts.com/purchase?ref=ONCHAINPROPS", chain: "Polymarket", isAffiliate: true, token: "No", payoutSpeed: "Weekly", rulesOnchain: "TBC", aiAgents: undefined, scaledCapital: undefined, evalDataOnchain: undefined, bestSplit: undefined, bestTargetToRisk: undefined, maxLeverage: undefined, bestLeverage: undefined, lowestFinalTarget: undefined, payoutsVerified: undefined }
    ],
    /** @type {PropFirm[]} */
    cryptoPropFirms: [
        { name: "SizeProp", country: "TBC", split: "Up to 95%", maxAccount: "$100,000", profitTarget: undefined, dailyDrawdown: undefined, maxDrawdown: undefined, website: "https://sizeprop.com/referral?ref=ONCHAINPROPS", chain: "", isAffiliate: true, token: "No", payoutSpeed: "~24h", rulesOnchain: "No", aiAgents: undefined, scaledCapital: undefined, evalDataOnchain: undefined, bestSplit: undefined, bestTargetToRisk: undefined, maxLeverage: undefined, bestLeverage: undefined, lowestFinalTarget: undefined, payoutsVerified: "No" }
    ],
    // GEN:END firm-data
    /** @type {string|null} */
    activeFaqId: null
...
const buildFirmRow = (firm, rank, { showProfitTarget = false } = {}) => {
    ...
    // Standout signal: lowest final-phase profit target among multi-step evaluations
    if (firm.lowestFinalTarget === 'Yes') {
        const finalTargetChip = document.createElement('span');
        finalTargetChip.className = 'trust-chip trust-chip--final-target';
        finalTargetChip.textContent = 'Lowest final-phase target';
        finalTargetChip.title = 'Lowest final-phase profit target among multi-step onchain evaluations in this directory';
        appendChip(finalTargetChip);
    }
